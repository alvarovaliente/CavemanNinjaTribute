...
#define GRAVITY 2.4
#define GRAVITY_SMOOTH 1.2
#define PLAYER_JUMP_TIME 350
#define PLAYER_FLYING_TIME 4000
#define PLAYER_NORMAL_SPEED 1.2
#define PLAYER_HIGH_SPEED 3
#define ENEMY_COLLIDER_BODY_WIDTH_RUNNING 35
#define ENEMY_COLLIDER_BODY_HEIGHT_RUNNING 40
#define ENEMY_COLLIDER_BODY_WIDTH_WALKING 25
#define ENEMY_COLLIDER_BODY_HEIGHT_WALKING 45

#define PICKUPFOOD_COLLIDER_BODY_WIDTH 15
#define PICKUPFOOD_COLLIDER_BODY_HEIGHT 15
